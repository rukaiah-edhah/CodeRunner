...
var purple_button = preload('res://images/themes/purple_button.tres')
...
func _ready():
	...
	volume_button.add_theme_stylebox_override('normal', purple_button)
	volume_button.add_theme_stylebox_override('hover', purple_button)
	volume_button.add_theme_stylebox_override('pressed', purple_button)
