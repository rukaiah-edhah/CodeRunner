...
var messages = [ 
    'Consider this example a piece of the essence of conversion:

age_float = 25.5
height_str = "175.5"
weight_int  = 60

# The fluidity of age converges toward the integer 25
age_int = int(age_float)  

# The appearance of height transforms into 175.5
height_float = float(height_str) 

# The numeral for weight undergoes a metamorphosis to "60"
