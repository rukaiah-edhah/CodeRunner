...
var messages = [
	"To invoke the execution of designs, the alignment of structure is paramount in Python's embrace. Indentation, the gentle curvature of spaces or tabs heralding a line's inception, delimiting its form and scope. Within the labyrinth of code, these indents direct the current, shaping its passage.
Traditionally, Python's script reveres four spaces as an indent. Attend to this illustration:

decree 1:
	decree 2
	decree 3

# decree 1's epilogue necessitates a colon. Be it a 'should an if',
'should a while', 'should a for', or 'should a def'."
	]
