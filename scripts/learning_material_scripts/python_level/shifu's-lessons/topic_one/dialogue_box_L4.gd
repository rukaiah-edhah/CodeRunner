...
var messages = [
	"Let us embark upon the rudiments: the art of Commenting. In the realm of coding, not only silicon minds decipher your script, but fellow souls - including your own future self. Comments, the brushstrokes of elucidation upon the canvas of logic, rendering the script legible to others (and yourself), sans the laborious dissection of each line."
	]
