...
var messages = [
    "In contrast, the specific-purpose languages are like rare gems, crafted for specialized tasks, each shining brightly in their designated roles. Gaze upon SQL, the master of databases, and HTML/CSS, the artful weaver of web pages' dreams."
    ]
