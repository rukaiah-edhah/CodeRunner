...
var correct_answers = {
    ...
    "background_color/code_container/panel/player_answer2": "float",
    "background_color/code_container/panel/player_answer3": "earth_dollars * conversion_rate",
    "background_color/code_container/panel/player_answer4": "{earth_dollars}",
