...
var correct_answers = {
    "background_color/code_container/panel/player_answer": "(your_age == 21) and (friend_age == 21)",
    "background_color/code_container/panel/player_answer2": "(18 < your_age < 25) and (18 < friend_age < 25)",
    "background_color/code_container/panel/player_answer3": ", can_ride_star_spinner)",
